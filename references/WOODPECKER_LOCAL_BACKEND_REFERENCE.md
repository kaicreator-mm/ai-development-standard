...
It proves only that the documented execution mapping worked for the stated real host and that the provider-neutral CI Execution Contract is necessary to avoid cross-backend assumptions.

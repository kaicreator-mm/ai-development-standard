...
When the pack contributes to a required Gate, identify the target exact SHA / Validation profile and preserve the standard five-state Gate semantics. Pack generation alone is not a release PASS.
